...
`eye --nope --n3 ../n3/modules/aux.n3 ../n3/modules/proof/contrast/invert_rules.n3 $rules --query ../n3/modules/proof/contrast/query_rules.n3 --quantify http://eyereasoner.github.io/var# > ../n3/tmp/rules-inv.n3`
