async function trace(rules, data, options) {
    ...
    if (options.aggregate) {
        ...
        rules = await eyereasoner.n3reasoner(rules, await get("n3/modules/proof/trace/aggr/distinguish_rules.n3"));
    ...
    // let proof = await get("n3/test/yellow1-proof.n3");
    ...
    let config =
    {
        ...
        n3: [
            ...
            { name: 'aux_trace.n3', path: "n3/modules/proof/trace/aux_trace.n3" }
        ]
    };

    if (options.aggregate)
        config.n3.push(
            { name: 'aux_aggr.n3', path: "n3/modules/proof/trace/aggr/aux_aggr.n3" },
            { name: 'aggregate_evidence.n3', path: "n3/modules/proof/trace/aggr/aggregate_evidence.n3" });
    else
...
async function contrast(rules, goal, options) {
    ...
    rules = await eyeWithConfig({
        ...
        n3: [
            ...
            { name: 'invert_rules.n3', path: "n3/modules/proof/contrast/invert_rules.n3" }
        ],
    });
    ...
    let config =
    {
        ...
        n3: [
            { name: 'proof.n3', data: proof },
            { name: 'aux_inv.n3', path: "n3/modules/proof/contrast/aux_inv.n3" }
        ]
    };
...
async function prove(rules, data) {
    ...
    let heads = await eyereasoner.n3reasoner(rules, await get("n3/modules/proof/query_heads.n3"));
...
class CorePrinter {
    ...
    constructor() {
        this.config =
        {
            ...
            n3: [
                { name: 'describe_core.n3', path: "n3/modules/print/describe.n3" }
            ]
        }
    }
...
class SimplePrinter extends CorePrinter {
    constructor() {
        ...
        this.config.n3.push(
            { name: 'describe.n3', path: "n3/modules/print/simple/describe.n3" },
            { name: 'collect.n3', path: "n3/modules/print/simple/collect.n3" });
        this.config.query = { name: 'query.n3', path: "n3/modules/print/simple/query.n3" };
    }
}
...
class VisualPrinter extends CorePrinter {
    constructor() {
        ...
        this.config.n3.push(
            { name: 'describe.n3', path: "n3/modules/print/visual/describe.n3" },
            { name: 'collect.n3', path: "n3/modules/print/visual/collect.n3" });
        this.config.query = { name: 'query.n3', path: "n3/modules/print/visual/query.n3" };
    }
}
...
class CopdPrinter extends VisualPrinter {
    constructor() {
        ...
        this.config.n3.push(
            { name: 'collect_copd.n3', path: "n3/modules/print/visual/copd/collect.n3" },
            { name: 'query_default.n3', path: "n3/modules/print/visual/copd/query.n3" });
    }
}